...
Read `docs/quality/studio-verification.md` and `references/evidence-contract.md` completely before running or judging a walkthrough.

1. Inspect `docs/planning/progress.md` and identify the exact claim to verify. Do not turn a broad phase into an implied pass.
...
9. Update `docs/planning/progress.md` only when the artifact supports the exact checkbox or exit criterion. Otherwise record the remaining gap and keep it open.
